#from flask.ext.sqlalchemy import SQLAlchemy  (doesn't work)
...
class Place(object):
    ...
    def query(self, address):
        ...
        query_url =\
           'https://en.wikipedia.org/w/api.php?action=query&list=geosearch&gsradius=5000&gscoord={0}%7C{1}&gslimit=20&format=json'.format(
              lat, lng)
